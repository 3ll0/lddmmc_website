...
function DarkThemeButton() {
  ...
  return (
    <input className="toggle-darkmode" type="checkbox" role="switch" value="off" onClick={ToggleDark} />
  )
}
...
function HeaderNavDropDown() {
  return (
    <nav className='header-navbar-dropdown'>
      ...
      <div className='header-navbar-dropdown-spacer'/>
      <div className='header-navbar-dropdown-social-container'>
        <a className='header-icon-container' href='https://www.facebook.com/profile.php?id=100090993057919' target='_blank'>
          <svg className='header-facebook-icon' width="24" height="24" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
            <path d="M12 2C6.5 2 2 6.5 2 12c0 5 3.7 9.1 8.4 9.9v-7H7.9V12h2.5V9.8c0-2.5 1.5-3.9 3.8-3.9 1.1 0 2.2.2 2.2.2v2.5h-1.3c-1.2 0-1.6.8-1.6 1.6V12h2.8l-.4 2.9h-2.3v7C18.3 21.1 22 17 22 12c0-5.5-4.5-10-10-10z"></path>
          </svg>
        </a>
        <a className='header-icon-container' href='https://www.instagram.com/lddmmc/' target='_blank'>
          <svg className='header-instagram-icon' width="24" height="24" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
